...
namespace DataLayer.DTO.AdminDTO
{
    public class ProviderProfileData
    {
        ...
        public string?   IsIndependentContract { get; set; }
        public string? IsBackgroundCheck { get; set; }
        public string? IsHIPAAC { get; set; }
        public string? IsNonDisclouser { get; set; }
        public string? IsLicenseDocument{ get; set; }
