        ...
        public List<RequestTableData> requestTableData(int status, int requesttype, string search)
        {
            ...
            if (requesttype == 0)
            {
                if (status == 1)
                {
                    ...
                    var my = db.Requests.Where(a => (a.Status == 1) && (new BitArray(1, false) == a.IsDeleted)).Include(b => b.RequestClients).ToList();
                ...
                else if (status == 2)
                {
                    ...
                    var my = db.Requests.Where(a => (a.Status == 2) && (new BitArray(1, false) == a.IsDeleted)).Include(b => b.RequestClients).ToList();
                    var mydata = my.Where(a =>
                        search.IsNullOrEmpty() ||
                        a.RequestClients.FirstOrDefault()!.FirstName!.Contains(search, StringComparison.CurrentCultureIgnoreCase) ||
                        a.RequestClients.FirstOrDefault()!.LastName!.Contains(search, StringComparison.CurrentCultureIgnoreCase));
                ...
                else if (status == 3)
                {
                    ...
                    var my = db.Requests.Where(a => (a.Status == 4) || (a.Status == 5) && (new BitArray(1, false) == a.IsDeleted)).Include(b => b.RequestClients).ToList();
                    var mydata = my.Where(a =>
                        search.IsNullOrEmpty() ||
                        a.RequestClients.FirstOrDefault()!.FirstName!.Contains(search, StringComparison.CurrentCultureIgnoreCase) ||
                        a.RequestClients.FirstOrDefault()!.LastName!.Contains(search, StringComparison.CurrentCultureIgnoreCase));
                ...
                else if (status == 4)
                {
                    ...
                    //var details = db.Requests;
                    var my = db.Requests.Where(a => (a.Status == 6) && (new BitArray(1, false) == a.IsDeleted)).Include(b => b.RequestClients).ToList();
                    var mydata = my.Where(a =>
                        search.IsNullOrEmpty() ||
                        a.RequestClients.FirstOrDefault()!.FirstName!.Contains(search, StringComparison.CurrentCultureIgnoreCase) ||
                        a.RequestClients.FirstOrDefault()!.LastName!.Contains(search, StringComparison.CurrentCultureIgnoreCase));
                ...
                else if (status == 5)
                {
                    ...
                    var my = db.Requests.Where(a => (a.Status == 3) || (a.Status == 7) || (a.Status == 8) && (new BitArray(1, false) == a.IsDeleted)).Include(b => b.RequestClients).ToList();
                    var mydata = my.Where(a =>
                        search.IsNullOrEmpty() ||
                        a.RequestClients.FirstOrDefault()!.FirstName!.Contains(search, StringComparison.CurrentCultureIgnoreCase) ||
                        a.RequestClients.FirstOrDefault()!.LastName!.Contains(search, StringComparison.CurrentCultureIgnoreCase));
                ...
                else if (status == 6)
                {
                    ...
                    //var details = db.Requests;
                    var my = db.Requests.Where(a => (a.Status == 9) && (new BitArray(1, false) == a.IsDeleted)).Include(b => b.RequestClients).ToList();
                    var mydata = my.Where(a =>
                        search.IsNullOrEmpty() ||
                        a.RequestClients.FirstOrDefault()!.FirstName!.Contains(search, StringComparison.CurrentCultureIgnoreCase) ||
                        a.RequestClients.FirstOrDefault()!.LastName!.Contains(search, StringComparison.CurrentCultureIgnoreCase));
                ...
                {
                    var my = db.Requests.Where(a=> (new BitArray(1, false) == a.IsDeleted)).Include(b => b.RequestClients).ToList();
                    var mydata = my.Where(a =>
                        search.IsNullOrEmpty() ||
                        a.RequestClients.FirstOrDefault()!.FirstName!.Contains(search, StringComparison.CurrentCultureIgnoreCase) ||
                        a.RequestClients.FirstOrDefault()!.LastName!.Contains(search, StringComparison.CurrentCultureIgnoreCase));
            ...
            else
            {
                ...
                if (status == 1)    
                {
                    ...
                    var my = db.Requests.Where(a => (a.Status == 1) && (new BitArray(1, false) == a.IsDeleted) && (a.RequestTypeId == requesttype)).Include(b => b.RequestClients).ToList();
                    var mydata = my.Where(a =>
                        search.IsNullOrEmpty() ||
                        a.RequestClients.FirstOrDefault()!.FirstName!.Contains(search, StringComparison.CurrentCultureIgnoreCase) ||
                        a.RequestClients.FirstOrDefault()!.LastName!.Contains(search, StringComparison.CurrentCultureIgnoreCase));
                ...
                else if (status == 2)
                {
                    ...
                    //var details = db.Requests;
                    var my = db.Requests.Where(a => (a.Status == 2) && (new BitArray(1, false) == a.IsDeleted) && (a.RequestTypeId == requesttype)).Include(b => b.RequestClients).ToList();
                    var mydata = my.Where(a =>
                        search.IsNullOrEmpty() ||
                        a.RequestClients.FirstOrDefault()!.FirstName!.Contains(search, StringComparison.CurrentCultureIgnoreCase) ||
                        a.RequestClients.FirstOrDefault()!.LastName!.Contains(search, StringComparison.CurrentCultureIgnoreCase));
                ...
                else if (status == 4)
                {
                    ...
                    //var details = db.Requests;
                    var my = db.Requests.Where(a => (a.Status == 6) && (new BitArray(1, false) == a.IsDeleted) && a.RequestTypeId == requesttype).Include(b => b.RequestClients).ToList();
                    var mydata = my.Where(a =>
                        search.IsNullOrEmpty() ||
                        a.RequestClients.FirstOrDefault()!.FirstName!.Contains(search, StringComparison.CurrentCultureIgnoreCase) ||
                        a.RequestClients.FirstOrDefault()!.LastName!.Contains(search, StringComparison.CurrentCultureIgnoreCase));
                ...
                else if (status == 5)
                {
                    ...
                    //var details = db.Requests;
                    var my = db.Requests.Where(a => (a.Status == 3 || a.Status == 7 || a.Status == 8) && (new BitArray(1, false) == a.IsDeleted) && (a.RequestTypeId == requesttype)).Include(b => b.RequestClients).ToList();
                    var mydata = my.Where(a =>
                        search.IsNullOrEmpty() ||
                        a.RequestClients.FirstOrDefault()!.FirstName!.Contains(search, StringComparison.CurrentCultureIgnoreCase) ||
                        a.RequestClients.FirstOrDefault()!.LastName!.Contains(search, StringComparison.CurrentCultureIgnoreCase));
                ...
                else if (status == 6)
                {
                    ...
                    //var details = db.Requests;
                    var my = db.Requests.Where(a =>( a.Status == 9) && (new BitArray(1, false) == a.IsDeleted) && (a.RequestTypeId == requesttype)).Include(b => b.RequestClients).ToList();
                    var mydata = my.Where(a =>
                        search.IsNullOrEmpty() ||
                        a.RequestClients.FirstOrDefault()!.FirstName!.Contains(search, StringComparison.CurrentCultureIgnoreCase) ||
                        a.RequestClients.FirstOrDefault()!.LastName!.Contains(search, StringComparison.CurrentCultureIgnoreCase));
                ...
                {
                    r = db.Requests.Where(a => (a.Status == status) && (new BitArray(1, false) == a.IsDeleted) && (a.RequestTypeId == requesttype)).Include(b => b.RequestClients).ToList();
                    var details = db.Requests;
